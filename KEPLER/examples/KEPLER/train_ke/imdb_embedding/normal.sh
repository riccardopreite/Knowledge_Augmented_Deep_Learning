...
fairseq-train $DATA_DIR --arch roberta_base --num-workers 16 --bpe gpt2 --fix-batches-to-gpus --sample-break-mode complete --separator-token 2 --distributed-init-method env://\
        --KEdata $KE_DATA \
