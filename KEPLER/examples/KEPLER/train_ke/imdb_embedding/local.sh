...
ROBERTA_PATH="~/projekt/models/keplerModel/KEPLERforKE.pt" #Path to the original roberta model
CHECKPOINT_PATH="checkpoints" #Directory to store the checkpoints
UPDATE_FREQ=`expr 77784 / $NUM_NODES` # Increase the batch size
...
fairseq-train $DATA_DIR \
        ...
        --reset-optimizer --distributed-world-size ${DIST_SIZE} --ddp-backend c10d \
