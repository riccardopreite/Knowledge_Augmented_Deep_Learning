...
CHECKPOINT_PATH="ke_attempt_reduced" #Directory to store the checkpoints
...
fairseq-train $DATA_DIR \
        ...
        --reset-optimizer --distributed-port 23460 --distributed-world-size ${DIST_SIZE} --ddp-backend no_c10d \
