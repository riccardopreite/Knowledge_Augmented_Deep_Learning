...
#ROBERTA_PATH="mlm_pretrained.pt"
ROBERTA_PATH="ke.pt"
...
fairseq-train $DATA_DIR --arch roberta\
        --KEdata $KE_DATA \
	...
	--ddp-backend no_c10d --log-format tqdm --log-interval 1 --reset-optimizer --distributed-port 23460 --distributed-world-size ${DIST_SIZE}
