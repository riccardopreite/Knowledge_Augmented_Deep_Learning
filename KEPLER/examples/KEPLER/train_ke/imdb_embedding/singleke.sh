...
ROBERTA_PATH="../MLM/mlm_checkpoint/checkpoint_best.pt" #Path to the original roberta model
...
fairseq-train $DATA_DIR \
        --KEdata $KE_DATA \
        --restore-file $ROBERTA_PATH --reset-dataloader\
        ...
        --reset-optimizer --distributed-port 23463 --distributed-world-size ${DIST_SIZE} --ddp-backend no_c10d \
