...
ROBERTA_PATH="mlm.pt"
#ROBERTA_PATH="ke.pt"
CHECKPOINT_PATH="normal_ke_attempt" #Directory to store the checkpoints
...
torchrun --nproc_per_node=2 \
    ...
    --master_port=12345 \
$(which fairseq-train) $DATA_DIR --arch roberta_base --num-workers 16 --bpe gpt2 --fix-batches-to-gpus --sample-break-mode complete --separator-token 2 --distributed-init-method env://\
        --KEdata $KE_DATA \
